...
$uip=$_SERVER['REMOTE_ADDR'];
$status=0;
$log=mysqli_query($con,"insert into userlog(userEmail,userip,status,login_time) values('$email','$uip','$status',now())");
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create your own User account.</p>
...
<div class="form-group">
	...
	<div class="checkbox">
		...
		<label class="checkbox">
 Keep a record of all your booked services.
		</label>
	</div>
</div>	
