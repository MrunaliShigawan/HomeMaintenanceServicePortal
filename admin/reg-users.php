...
if($query)
{
	echo "<script>alert('User $email has removed succesfully');</script>";
}
else{
...
<head>
    ...
    <title>Online Library Management System | Manage Reg users</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Register Users</h4>
    </div>
...
<td class="center"><?php echo htmlentities($result['name']);?></td>
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="reg-users.php?emailid=<?php echo htmlentities($result['email']);?>" onclick="return confirm('Are you sure you want to remove this Userr?');" >  <button class="btn btn-danger"> Remove</button></a>
