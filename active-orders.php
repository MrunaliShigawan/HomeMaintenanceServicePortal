...
$query=mysqli_query($con,"UPDATE `bookservice` SET `status`='Finished',fdate=now() WHERE userEmail='".$_SESSION['login']."' and spname='$spname'");
if($query)
{
...
<div class="body-content outer-top-bd">
	<div class="container">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Active Order List</h4>
    </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
 // $sql1="SELECT * FROM `serviceprovider` where email='$_SESSION['login']'";                                      
$sql="SELECT * FROM `bookservice` where userEmail='".$_SESSION['login']."' and status='Active'";
...
<td class="center"><?php echo htmlentities($result['spname']);?></td>
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="active-orders.php?spname=<?php echo htmlentities($result['spname']);?>" onclick="return confirm('Are you sure you want to mark as work done?');" >  <button class="btn btn-danger">Work Done</button></a>
