...
<html lang="en">
	<head>
	    ...
	    <title>Electrician Service</title>
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item">
                ...
                <a href="electrician-service.php?cid=1"  class="dropdown-toggle" >
                        Switches, Meters and Fuses</a>
                <a href="electrician-service.php?cid=2"  class="dropdown-toggle" >
                        Wiring</a>
                <a href="electrician-service.php?cid=3" class="dropdown-toggle" >
                        Lights, Fans and Inverter</a>
			...
			<?php
                        $cid=intval($_GET['cid']);
if($cid == 1){
    $subcat='Switches,Meters-and-Fuses';
    ?><h3>Switches, Meters and Fuses</h3><br><?php
}
if($cid == 2){
    $subcat='Wiring';
    ?><h3>Wiring</h3><br><?php
...
if($cid == 3){
    $subcat='Lights,Fans-and-Inverter';
    ?><h3>Lights, Fans and Inverter</h3><br><?php
}
